...
namespace gandalf {
    MBC1::MBC1(const ROM& rom, std::size_t rom_banks, std::size_t ram_banks) : MBC(rom, rom_banks, ram_banks), ram_enabled_(false), rom_bank_number_(0), ram_bank_number_(0), advanced_banking_mode_(false) {
