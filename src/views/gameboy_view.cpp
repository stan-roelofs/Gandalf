...
namespace gui
{
        ...
        context_(context)
    {
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB5_A1, gandalf::ScreenWidth, gandalf::ScreenHeight, 0, GL_RGBA, GL_UNSIGNED_SHORT_1_5_5_5_REV, front_buffer_->data());
    }
    ...
    {
        glBindTexture(GL_TEXTURE_2D, texture_);
        glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, gandalf::ScreenWidth, gandalf::ScreenHeight, GL_RGBA, GL_UNSIGNED_SHORT_1_5_5_5_REV, front_buffer_->data());
        ...
        ImGui::Image((void*)(intptr_t)texture_, ImVec2(static_cast<float>(gandalf::ScreenWidth * context_.GetSettings().scale), static_cast<float>(gandalf::ScreenHeight * context_.GetSettings().scale)));
        ImGui::End();
        ImGui::PopStyleVar();
    }
